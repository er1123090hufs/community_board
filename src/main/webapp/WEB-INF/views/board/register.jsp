        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" name="writer" value="<c:out value="입력하시오"/>">
                </div>
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" name="title" value="<c:out value="입력하시오"/>">
                </div>
                ...
                <div class="input-group">
                    ...
                    <textarea name="contents"><c:out value="입력하시오"/></textarea>
                </div>
